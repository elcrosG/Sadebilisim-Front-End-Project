...
$mail->Host = $dt_mail_host; 
$mail->Username = $dt_mail_username; 
$mail->Password = $dt_mail_password;
$mail->Port = $dt_mail_port; 
$mail->SMTPSecure = 'tls'; 
...
$mail->setFrom($dt_mail, $_POST['user-name']);
$mail->addAddress($gitMail, $_POST['user-name']);


$mail->Subject = $_POST['user-name'].' tarafından gönderilen demo talep formu.';
$mail->Body =
'
            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td valign="top" align="center" style="font-family:\'Open Sans\', Arial, sans-serif; font-size:17px;line-height:22px; font-weight:bold; color:#ffffff; text-transform:uppercase;">'.$dt_kategori.'</td>
                  </tr>
                  <tr>
                        ...
                        <tr>
                          ...
                          <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td align="left" valign="top"  class="em_font1" style="font-family:\'Open Sans\', Arial, sans-serif; font-size:17px; line-height:20px; font-weight:bold; color:#48b7b1; ">Talep Konusu : &nbsp;<span style=" color:#30373b;">'.$_POST['inceleme-sebebi'].'</span></td>
                              </tr>
                              <tr>
                                <td height="12" style="font-size:1px; line-height:1px;">&nbsp;</td>
                              </tr>
                        ...
                        <tr>
                          ...
                          <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td align="left" valign="top"  class="em_font1" style="font-family:\'Open Sans\', Arial, sans-serif; font-size:17px; line-height:20px; font-weight:bold; color:#48b7b1; ">Paket Seçimi : &nbsp;<span style=" color:#30373b;">'.$_POST['yazilim'].'</span></td>
                              </tr>
                              <tr>
                                <td height="12" style="font-size:1px; line-height:1px;">&nbsp;</td>
                              </tr>
                        ...
                        <tr>
                          ...
                          <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td align="left" valign="top"  class="em_font1" style="font-family:\'Open Sans\', Arial, sans-serif; font-size:17px; line-height:20px; font-weight:bold; color:#48b7b1; ">Site : &nbsp;<span style=" color:#30373b;">'.$_POST['user-site'].'</span></td>
                              </tr>
                              <tr>
                                <td height="12" style="font-size:1px; line-height:1px;">&nbsp;</td>
                              </tr>
